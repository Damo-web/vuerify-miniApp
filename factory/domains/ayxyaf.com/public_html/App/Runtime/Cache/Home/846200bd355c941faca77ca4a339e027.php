...
<h2 id="newTitle"><strong><?php echo ($list['title']); ?></strong></h2>
                        ...
                        <?php if($list['is_open'] == 0): if($list['img'] != ''): ?><p id="infoImage"><a href="__ROOT__/__UPLOAD__/<?php echo ($list['img']); ?>" class="mesmore"><img src="__ROOT__/__UPLOAD__/<?php echo ($list['img']); ?>" alt="<?php echo ($list['title']); ?>"/></a></p><?php endif; endif; ?>
                        <div id="newsContent">
                        ...
                        <p class="">相关信息</p>
                        <ul>
                       <?php if(is_array($related)): $i = 0; $__LIST__ = $related;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><b>&middot;</b><a href="__APP__/news/<?php echo ($vo["pid"]); ?>_<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>"><?php echo (msubstr($vo["title"],0,15,'utf-8',false)); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                        </div>
